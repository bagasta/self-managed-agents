...
class Settings(BaseSettings):
    ...
    arthur_primary_model: str = "openai/gpt-4.1-mini"
    ...
    # Memory
    short_term_memory_turns: int = 8   # conversation turns kept in LLM context
    ltm_extraction_every: int = 5       # extract LTM every N user messages

    # WhatsApp microservice (legacy QR-based — will be deprecated)
    ...
    app_public_url: str = "https://accessibility-netscape-suffered-origins.trycloudflare.com"
    meta_app_id: str = "1267421042076588"
    meta_app_secret: str = ""
    meta_webhook_verify_token: str = ""
    meta_graph_api_version: str = "v26.0"
    meta_embedded_signup_config_id: str = "2310023142810963"
