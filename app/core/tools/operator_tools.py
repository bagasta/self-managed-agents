...
def build_operator_tools(agent_id: uuid.UUID, db_factory: async_sessionmaker) -> list:
    """
    ...
    async def _disable_ai_for_user(phone: str) -> str:
        ...
        log.info("operator_tools.disable_ai.done")
        return (
    ...
    async def _enable_ai_for_user(phone: str) -> str:
        ...
        log.info("operator_tools.enable_ai.done")
        return (
