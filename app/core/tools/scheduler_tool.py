...
def build_scheduler_tools(session_id: uuid.UUID, agent_id: uuid.UUID, db_factory: async_sessionmaker) -> list:
    ...
    _set_reminder.__doc__ = (
        ...
        "BUKAN UTC.\n\n"
        "PENTING:\n"
        "- Jika user menyebut jam spesifik tanpa kata 'setiap', 'harian', 'daily', atau pola berulang, "
        "gunakan ISO datetime sekali jalan, BUKAN cron.\n"
        "- Cron hanya untuk jadwal berulang yang eksplisit.\n"
        "- Contoh: user bilang 'ingetin jam 16.30 buat meeting' pada 2026-05-19 → "
        "schedule='2026-05-19T16:30:00', bukan '30 16 * * *'.\n\n"
        "Args:\n"
    ...
    _set_multiple_reminders.__doc__ = (
        ...
        "PENTING: Jam spesifik tanpa kata berulang berarti one-time ISO datetime. Cron hanya untuk jadwal berulang eksplisit.\n\n"
        "Args:\n"
