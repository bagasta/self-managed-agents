    ...
    if has_wrapper:
        ...
        if enabled:
            ...
            if default_url:
                ...
                elif "google_workspace" in normalized and "url" not in normalized["google_workspace"]:
                    normalized["google_workspace"]["url"] = default_url
                    normalized["google_workspace"].setdefault("transport", "streamable_http")
