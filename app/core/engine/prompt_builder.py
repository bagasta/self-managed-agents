    ...
    *,
    ...
    if "builder" in active_groups:
        ...
        system_prompt += (
            ...
            "- Untuk tone serta contoh percakapan ideal/terlarang, beri contoh dulu agar user paham formatnya. Ideal wajib 2-3 contoh. Jangan menerima persona generik sebagai pengganti contoh interaksi dan red line.\n"
