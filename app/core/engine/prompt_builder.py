    ...
    *,
    ...
    if "builder" in active_groups:
        ...
        system_prompt += (
            ...
            "- Discovery dilakukan satu grup per pesan. Jika user sudah memberi sebagian jawaban, simpan hanya fakta itu dan tanyakan semua item yang masih kosong pada grup terkait. DILARANG mengisi jawaban sendiri. Selalu kirim ulang seluruh jawaban yang terkumpul pada parameter discovery_answers plan_agent. Jika plan_agent mengembalikan next_group/next_questions, tanyakan grup itu dan JANGAN compose/create.\n"
