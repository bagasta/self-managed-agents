    ...
    *,
    ...
    if "deploy" in active_groups:
        system_prompt += (
            ...
            "ATURAN OUTPUT:\n"
            "- Jangan mengirim progress seperti 'saya tulis dulu' sebagai jawaban final. Lanjutkan tool call sampai URL deploy ada atau ada error nyata yang tidak bisa diperbaiki.\n"
