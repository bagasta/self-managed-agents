...
def _build_arthur_tool_category_guide() -> str:
    return (
        ...
        "kalau tool payment belum tersedia. Semua penjelasan dan tindakan dilakukan lewat chat "
        "WhatsApp ini. Jangan pernah mengarahkan user membuka dashboard, menu Settings, atau UI lain. "
        "Jika subscription bermasalah, jelaskan blocker yang benar-benar dibuktikan tool dan berikan "
        "payment link bila tersedia.\n"
