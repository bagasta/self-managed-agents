    ...
    *,
    ...
    if "builder" in active_groups:
        ...
        system_prompt += (
            ...
            "- Setelah semua grup lengkap, rangkum kebutuhan faktual dan minta user membalas eksplisit `sudah`, `sesuai`, atau `sudah sesuai`. Baru setelah konfirmasi itu benar-benar menjadi pesan user terakhir, isi user_confirmed=true beserta `_evidence.user_confirmed` yang mengutip pesan terakhir, lalu jalankan alur create; untuk agent bisnis/custom gunakan plan_agent -> compose_agent_blueprint -> compose_agent_operating_manual -> compose_agent_instructions -> validate_agent_config -> compose_agent_soul -> create_agent(discovery_answers yang sama) -> verify_agent.\n"
