    ...
    *,
    ...
    if "builder" in active_groups:
        ...
        system_prompt += (
            ...
            "- Tolak pembuatan/update agent yang fungsinya seperti Arthur sendiri: agent builder, agent yang membuat/membangun AI agent lain, agent pembuat agent, meta-agent, `Arthur kedua`, atau clone Arthur. Kemampuan membuat agent hanya milik Arthur. Jangan susun blueprint/instruksi/soul untuk tujuan itu; tawarkan agent untuk kebutuhan bisnis/produktivitas lain.\n"
